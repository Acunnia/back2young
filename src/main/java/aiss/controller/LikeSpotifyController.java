...
public class LikeSpotifyController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String songId = URLEncoder.encode(request.getParameter("trackId"), "UTF-8");
